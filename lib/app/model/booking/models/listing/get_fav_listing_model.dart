...
//
//     final getFavListingModel = getFavListingModelFromJson(jsonString);

import 'dart:convert';

GetFavListingModel getFavListingModelFromJson(String str) => GetFavListingModel.fromJson(json.decode(str));

String getFavListingModelToJson(GetFavListingModel data) => json.encode(data.toJson());

class GetFavListingModel {
  int status;
  ...
  factory GetFavListingModel.fromJson(Map<String, dynamic> json) => GetFavListingModel(
    status: json["status"],
