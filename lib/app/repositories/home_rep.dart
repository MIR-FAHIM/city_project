...
//
//
//     Uri url = Uri.parse( ApiClient.getDistrict,);
//     final response = await http.get(
//       url,
//       headers: {
//         "Content-Type": "application/json",
...
//   //   return data;
//   // }
//   // Future editBloodGroupProfileRep(blood) async {
//   //
//   //
//   //   Uri url = Uri.parse( ApiUrl.editProfile,);
//   //   final response = await http.post(
...
//   //   return data;
//   // }
//   // Future editDonateStatusProfileRep(donate) async {
//   //
//   //
//   //   Uri url = Uri.parse( ApiUrl.editProfile,);
//   //   final response = await http.post(
...
//   //       },
//   //       body: {
//   //         "active_donator": donate == true ? "1" : "0",
//   //         "_method" : "PUT"
//   //       }
//   //   );
//   //
